...
public class AboutCasting {
	...
	public void downCastWithInheritance() {
		...
		assertEquals(parentReference instanceof Child, true); // why is this? object was casted from child to parent
		assertEquals(parentReference instanceof Parent, true); // child extends parent
		assertEquals(parentReference instanceof Grandparent, true); // and parent extends grandparent
	}
	...
	public void upCastWithInheritance() {
		...
		assertEquals(childReference instanceof Child, true); // because of explicit cast?
		assertEquals(childReference instanceof Parent, true); // it looks like it
